import { CliOptions, ResponseConditions } from './types';
...
export const mockTemplate = (operationCollection: OperationCollection, baseURL: string, responseConditions?: ResponseConditions, options?: CliOptions) => `/**
...
export const handlers = [
  ${transformToHandlerCode(operationCollection, responseConditions)}
];
